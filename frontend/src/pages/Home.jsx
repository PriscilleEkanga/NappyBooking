...
function Home() {
  ...
  // --- AJOUT : États pour la recherche ---
  const [searchQuery, setSearchQuery] = useState("");
  const [searchCity, setSearchCity] = useState("");
  const navigate = useNavigate(); // N'oublie pas l'import de useNavigate en haut du fichier
  // ---------------------------------------
  ...
  const imagesHero = [hero1, hero2, hero3];

  const services = [
    {
      title: "Coiffeuses",
      desc: "Envie de changer de tête ou de coupe ? Vous avez besoin d'un expert pour vous conseiller sur vos soins naturels, tresses ou locks.",
      img: imgCoiffure,
      link: "/coiffeuses",
    },
    {
      title: "Manucure",
      desc: "Offrez à vos mains le soin qu'elles méritent. Pose de vernis, gel ou nail art par nos prothésistes ongulaires expertes.",
      img: imgManucure,
      link: "/manucure",
    },
    {
      title: "Maquillage",
      desc: "Sublimez votre visage pour vos grands événements. Un maquillage professionnel qui respecte votre carnation et vos envies.",
      img: imgMaquillage,
      link: "/maquillage",
    },
    {
      title: "Extensions de cils",
      desc: "Un regard intense dès le réveil. Nos techniciennes spécialisées vous proposent des poses classiques ou volume russe.",
      img: imgCils,
      link: "/cils",
    },
  ];
  ...
  // --- AJOUT : Fonction de redirection intelligente ---
  const handleGlobalSearch = () => {
    ...
    if (
      query.includes("manucure") ||
      query.includes("ongle") ||
      query.includes("vernis") ||
      query.includes("gel")
    ) {
      navigate(`/manucure${cityPath}`);
    } else if (
      query.includes("maquillage") ||
      query.includes("makeup") ||
      query.includes("maquilleuse")
    ) {
      navigate(`/maquillage${cityPath}`);
    } else if (
      query.includes("cil") ||
      query.includes("regard") ||
      query.includes("sourcil")
    ) {
      navigate(`/cils${cityPath}`);
    } else {
      // Par défaut redirige vers coiffure
      navigate(`/coiffeuses${cityPath}`);
    }
  };
  // ----------------------------------------------------
    ...
    <div style={{ backgroundColor: colors.porcelain, overflowX: "hidden" }}>
      ...
      >
        ...
        >
          ...
          >
            Coiffeuses, manucures et maquilleuses expertes partout en France.
          </p>
          ...
          <button
            onClick={() => {
              const isAuthenticated =
                localStorage.getItem("isAuthenticated") === "true"; // Ou ton test de token

              if (isAuthenticated) {
                // Si connecté : direct au booking
                navigate("/booking/1?service=coiffure");
              } else {
                // Si pas connecté : on enregistre l'intention et on envoie vers login
                localStorage.setItem(
                  "redirectAfterLogin",
                  "/booking/1?service=coiffure",
                );
                navigate("/login");
              }
            }}
            style={{
              ...
              cursor: "pointer",
              transition: "0.3s",
              boxShadow: "0 10px 20px rgba(179, 114, 86, 0.3)",
            }}
            onMouseEnter={(e) =>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "60px" }}>
            ...
            >
              ...
              , notre mission est de célébrer la beauté des cheveux afro sans
              complexe partout en France.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p style={{ color: "#666" }}>
                Des professionnels qui maîtrisent réellement les cheveux crépus,
                frisés et bouclés.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ color: "#666" }}>
                Une charte stricte pour garantir la ponctualité et la
                bienveillance à chaque prestation.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ color: "#666" }}>
                Rendre les soins spécialisés accessibles dans toutes les villes
                de France, même les plus petites.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ color: "#666" }}>
                Moderniser les salons afro avec des outils de réservation
                innovants et un paiement sécurisé.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          >
            NappyBooking recherche des partenaires dans toute la France pour
            digitaliser le secteur de la beauté.
          </p>
          ...
          >
            {[
              {
                title: "Rappels SMS",
                desc: "Réduisez les rendez-vous non honorés grâce aux rappels automatiques par SMS.",
              },
              {
                title: "24h/24 & 7j/7",
                desc: "50% des rendez-vous sont pris en ligne en dehors de vos horaires d'ouverture.",
              },
              {
                title: "Visibilité ciblée",
                desc: "Apparaissez devant des milliers de clientes cherchant spécifiquement votre expertise.",
              },
              {
                title: "Paiement sécurisé",
                desc: "Garantissez vos revenus avec le système d'acompte obligatoire en ligne.",
              },
              {
                title: "Gestion simplifiée",
                desc: "Un agenda intelligent pour piloter votre activité et vos collaboratrices sans stress.",
              },
              {
                title: "Suivi Personnalisé",
                desc: "Historique, préférences et statistiques : connaissez vos clientes et leurs besoins sur le bout des doigts.",
              },
            ].map((box, index) => (
              <div
                key={index}
      ...
      >
        ...
        >
          ...
          >
            Découvrez les témoignages de nos clients satisfaites à travers la
            France
          </p>
            ...
            {[
              {
                ...
                city: "Paris, France",
                img: imgPriscille,
                text: "Enfin une plateforme qui me connecte avec des coiffeuses qui comprennent vraiment les cheveux naturels.",
              },
              {
                name: "Laury",
                city: "Nantes, France",
                img: imgLaury,
                text: "Le cadre est super professionnel et j'ai enfin trouvé une experte pour mes locks à Nantes.",
              },
              {
                name: "Rebecca",
                city: "Paris, France",
                img: imgRebecca,
                text: "La réservation est fluide et le paiement sécurisé rassure énormément.",
              },
            ].map((avis, index) => (
              <div
                key={index}
              ...
              >
                ...
                <div
                  style={{ display: "flex", gap: "2px", marginBottom: "15px" }}
                >
                  {[1, 2, 3, 4, 5].map((s) => (
                    <svg
                      key={s}
      ...
      >
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div
            style={{
              display: "grid",
              // 1fr sur mobile, 1fr 1fr sur tablette, 1fr 1fr 1fr 1fr sur desktop
              gridTemplateColumns:
            ...
            <div>
              ...
              >
                {[
                  ...
                  <Link
                    key={city}
                    to={`/maquillage/${city.toLowerCase()}`}
                    style={{
                      color: "#666",
                      textDecoration: "none",
                      fontSize: "0.95rem",
        ...
        >
          ...
          <div>
            ...
            <p style={{ opacity: 0.7, lineHeight: "1.6", fontSize: "0.95rem" }}>
              La première plateforme dédiée à la beauté afro en France. Réservez
              les meilleures expertes pour vos cheveux naturels, tresses et
              soins.
            </p>
          </div>
